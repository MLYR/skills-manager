...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai::list_ai_analysis_batches,
            commands::ai::list_ai_analysis_jobs,
            commands::ai::get_ai_analysis_batch,
            commands::ai::get_ai_analysis_queue_stats,
            commands::ai::pause_ai_analysis_batch,
            commands::ai::resume_ai_analysis_batch,
